...
=== b.
Four numbers add up to $9$, #box(stroke: 1pt, inset: 6pt)[$(9+3)! / (3!9!)$] ways to have numbers add up to $9$

The numbers can be zero, since $0001 = 1$ is valid!

=== c.
Four numbers that add up to $18$, so there must be #box(stroke: 1pt, inset: 6pt)[$std.math.binom(18 + 3, 3)$] ways
